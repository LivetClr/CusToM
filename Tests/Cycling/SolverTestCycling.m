classdef SolverTestCycling < matlab.unittest.TestCase
    methods(Test)
        function ResultsTestWithoutComputingHumanModel(testCase)
            ...
            testCase.assertEqual(InverseKinematicsResults,InverseKinematicsResults_Expected,'RelTol',1e-5,'AbsTol',1e-6);
            
               
            ExperimentalData_Expected = load([path_expectation, '/ExperimentalData.mat']);
            ExperimentalData = load([path, '/ExperimentalData.mat']);
            
            testCase.assertEqual(ExperimentalData,ExperimentalData_Expected,'RelTol',1e-5,'AbsTol',1e-6);
            ...
            testCase.assertEqual(ExternalForcesComputationResults,ExternalForcesComputationResults_Expected,'RelTol',1e-5,'AbsTol',1e-6);
            ...
            testCase.assertEqual(InverseDynamicsResults,InverseDynamicsResults_Expected,'RelTol',1e-5,'AbsTol',1e-6);
            ...
            testCase.assertEqual(MuscleForcesComputationResults,MuscleForcesComputationResults_Expected,'RelTol',1e-5,'AbsTol',1e-6);
